                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content" id="tab-futbol-contenido">
                                            <div class="tab-pane fade show active" id="semana1" role="tabpanel" aria-labelledby="tab-futbol-general">
                                                <form action="imc/partidosFut.php" method="post">
                                                    <table class="table table-hover">
                                                        ...
                                                        for ($partidoscont2=1; $partidoscont2<$partidos+1; $partidoscont2++){
                                                            $sql2 = "select * from partidos_futbol where semana=1";
                                                            ...
                                                            if($resultado2){
                                                                ...
                                                                if (empty($partidos1)){
                                                                    ...
                                                                    $set1local = $partidos1[$partidoscont2-1]['goles_local'];
                                                                    $set2local = $partidos1[$partidoscont2-1]['goles_visitante'];
                                                                    ?>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><input type="number" name="gollocal1-<?php echo $partidoscont2?>" value="<?php echo $set1local?>" readonly></td>
                                                                        <td>vs<input type="number"style="width: 0px; border: none" value="1" name="oculto" readonly ></td>
                                                                        <td><input type="number" name="golvisita1-<?php echo $partidoscont2?>" value="<?php echo $set1local?>" readonly></td>
                                                                        <td>
                                                                            <?php
                                                ...
                                                <div class="tab-pane fade" id="semana<?php echo $jornadascont2; ?>" role="tabpanel" aria-labelledby="tab-futbol-jugadores">
                                                    <form action="imc/partidosFut.php" method="post" >
                                                        <table class="table table-hover">
                                                            ...
                                                            <?php
                                                            for ($partidoscont2=1; $partidoscont2<$partidos+1; $partidoscont2++){
                                                                $sql2 = "select * from partidos_futbol where semana=$jornadascont2";
                                                                $resultado2 = mysqli_query($conexion, $sql2);
                                                                if($resultado2){
                                                                    $partidos1 = array();
                                                                    while($fila = mysqli_fetch_assoc($resultado2)){
                  ...
                  <!-- Agregar goles individuales -->
                        <div class="col-xl-12 col-lg-5">
                            <div class="card shadow mb-4">
                                <!-- Card Header - Dropdown -->
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Goleadores</h6>
                                </div>
                                <div class="card-body">
                                    <table class="table table-hover">
                                        <tr>
