...
for ($partidoscont=1; $partidoscont<$partidos+1; $partidoscont++) {
    ...
    $gollocal = $_POST["ptnlocal$semana-$partidoscont"];
    $golvisita=$_POST["ptnvisita$semana-$partidoscont"];

    $df=$gollocal-$golvisita;




    $insert = "insert into partidos_basquetbol (localx,visitante,id_torneo, puntos_local, puntos_visitante, semana, fecha_creacion)
