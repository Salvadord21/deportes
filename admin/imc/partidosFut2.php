...
$insert="UPDATE `partidos_ascenso` SET `gol_local`='$golLocal',`gol_visita`='$golVisita',`resultado`='$resultado' WHERE `id_local`='$idLocal' and `id_visita`='$idVisita' and `jornada`='$jornada'";
