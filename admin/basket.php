                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <!-- llama al torneo -->
                                <?php
                                $sql= "SELECT * FROM `torneos` WHERE diciplina='Basquetbol' AND fecha_creacion = ( SELECT MAX(fecha_creacion) FROM `torneos` WHERE diciplina = 'Basquetbol')";
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content" id="tab-futbol-contenido">
                                            <div class="tab-pane fade show active" id="semana1" role="tabpanel" aria-labelledby="tab-futbol-general">
                                                <form action="imc/partidoBas.php" method="post">
                                                    <table class="table table-hover">
                                                        ...
                                                        for ($partidoscont2=1; $partidoscont2<$partidos+1; $partidoscont2++){
                                                            $sql2 = "select * from partidos_basquetbol where semana=1";
                                                            ...
                                                            if($resultado2){
                                                                ...
                                                                if (empty($partidos1)){
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><input type="number" name="ptnlocal1-<?php echo $partidoscont2?>"></td>
                                                                        <td>vs<input type="number"style="width: 0px; border: none" value="1" name="oculto" readonly ></td>
                                                                        <td><input type="number" name="ptnvisita1-<?php echo $partidoscont2?>"></td>
                                                                    ...
                                                                    $set1local = $partidos1[$partidoscont2-1]['puntos_local'];
                                                                    $set2local = $partidos1[$partidoscont2-1]['puntos_visitante'];
                                                                    ?>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><input type="number" name="ptnlocal1-<?php echo $partidoscont2?>" value="<?php echo $set1local?>"readonly></td>
                                                                        <td>vs<input type="number"style="width: 0px; border: none" value="1" name="oculto" readonly ></td>
                                                                        <td><input type="number" name="ptnvisita1-<?php echo $partidoscont2?>" value="<?php echo $set1local?>"readonly></td>
                                                                        <td>
                                                                            <?php
                                                ...
                                                <div class="tab-pane fade" id="semana<?php echo $jornadascont2; ?>" role="tabpanel" aria-labelledby="tab-futbol-jugadores">
                                                    <form action="imc/partidoBas.php" method="post" >
                                                        <table class="table table-hover">
                                                            ...
                                                            <?php
                                                            for ($partidoscont2=1; $partidoscont2<$partidos+1; $partidoscont2++){
                                                                $sql2 = "select * from partidos_basquetbol where semana=$jornadascont2";
                                                                $resultado2 = mysqli_query($conexion, $sql2);
                                                                if($resultado2){
                                                                    $partidos1 = array();
                                                                    while($fila = mysqli_fetch_assoc($resultado2)){
                                                                    ...
                                                                    if (empty($partidos1)){
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><input type="number" name="ptnlocal<?php echo $jornadascont2?>-<?php echo $partidoscont2?>"></td>
                                                                            <td>vs<input type="number"style="width: 0px; border: none" value="<?php echo $jornadascont2?>" name="oculto" readonly ></td>
                                                                            <td><input type="number" name="ptnvisita<?php echo $jornadascont2?>-<?php echo $partidoscont2?>"></td>
                                                                            <td><select name="visita<?php echo $jornadascont2?>-<?php echo $partidoscont2?>[]">
                                                                                    <option value="value1">Visita</option>
                                                                                    <?php
                                                                                    require 'imc/EquiposBas.php';
                                                                                    ?>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><input type="number" name="ptnlocal<?php echo $jornadascont2?>-<?php echo $partidoscont2?>" value="<?php echo $set1local?>"readonly></td>
                                                                            <td>vs<input type="number"style="width: 0px; border: none" value="$jornadascont2" name="oculto" readonly ></td>
                                                                            <td><input type="number" name="ptnvisita<?php echo $jornadascont2?>-<?php echo $partidoscont2?>" value="<?php echo $set1local?>"readonly></td>
                                                                            <td>
                                                                                <?php
                                                                                echo $nombreEquipovisita;
                                                                                ?>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <table class="table table-hover">
                                        ...
                                        ?>
                                        <tr>
                                            <form action="jugadoresB.php"method="post">
